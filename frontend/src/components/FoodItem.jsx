      ...
      <div className="relative overflow-hidden h-48">
        ...
        {!cartItems[id] ? (
          <button
            ...
            className="absolute bottom-12 right-4 bg-white text-primary font-semibold px-4 py-2 rounded-full shadow-lg hover:bg-primary hover:text-white transition-all btn-ripple flex items-center gap-2"
          >
            <FaPlus className="text-sm" /> Add to Cart
          </button>
        ) : (
          <div className="absolute bottom-12 right-4 bg-white rounded-full flex items-center gap-3 px-3 py-2 shadow-lg">
            <button
